...
if config['args'].get('genome'):
    ...
    targets['annotate'].append(expand(os.path.join(dir_final, "{sample}", "{sample}_pharokka_annot_output.tsv"), sample=samples_names))
    targets['annotate'].append(expand(os.path.join(dir_final, "{sample}", "{sample}_phold_annot_output.tsv"), sample=samples_names))
    targets['annotate'].append(expand(os.path.join(dir_final, "{sample}", "{sample}_phold_acr_output.tsv"), sample=samples_names))
    targets['annotate'].append(expand(os.path.join(dir_final, "{sample}", "{sample}_phold_card_output.tsv"), sample=samples_names))
    targets['annotate'].append(expand(os.path.join(dir_final, "{sample}", "{sample}_phold_defense_output.tsv"), sample=samples_names))
    targets['annotate'].append(expand(os.path.join(dir_final, "{sample}", "{sample}_phold_vfdb_output.tsv"), sample=samples_names))